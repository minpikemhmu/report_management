        ...
        <div class="card mx-auto mb-5 mt-3">
            <div class="row m-3">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <span class="">Add a new Product</span>
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" id="name"
                                aria-describedby="textHelp" placeholder="Enter New Product Name" value="{{ old('name') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="product_code" type="text" class="form-control" id="product_code"
                                placeholder="Enter New Product Code" value="{{ old('product_code') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="brn_code" type="text" class="form-control" id="brn_code"
                                placeholder="Enter New Product BNR Code" value="{{ old('brn_code') }}">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-feedback text-danger"> {{ $errors->first('product_sub_category_id') }} </div>
                    </div>
