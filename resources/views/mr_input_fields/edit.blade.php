        ...
        <div class="card mx-auto mb-5 mt-3">
            <div class="row m-3">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <span class="">Edit Existing Field</span>
                    <form method="POST" action="{{ route('mr_input_fields.update', $field->id) }}">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="merchandiser_report_type_id" value="{{$field->merchandiser_report_type_id}}">
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-single1" id="merchandiser_report_type_id" name="merchandiser_report_type_id">
                                ...
                                @foreach ($report_types as $row)
                                    <option {{ $field->merchandiser_report_type_id === $row->id ? "selected" : "" }} value="{{ $row->id }}">{{ $row->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input name="display_name" type="text" class="form-control" id="display_name"
                                aria-describedby="textHelp" placeholder="Enter New Display Name" value="{{ old('display_name', $field->display_name ?? '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="display_order" type="number" class="form-control" id="display_order"
                                placeholder="Enter Display Order" value="{{ old('display_order', $field->display_order ?? '') }}">
                        ...
                        <select class="form-control js-example-basic-single1" id="field_type" name="field_type">
                            ...
                            <option {{$field->field_type === "number_input" ? "selected" : "" }} value="number_input">number_input</option>
                            <option {{$field->field_type === "text_input"? "selected" : "" }} value="text_input">text_input</option>
                            <option {{$field->field_type === "file_input"? "selected" : "" }} value="file_input">file_input</option>
                            <option {{$field->field_type === "list_input"? "selected" : "" }} value="list_input">list_input</option>
                            <option {{$field->field_type === "radio_input"? "selected" : "" }} value="radio_input">radio_input</option>
                            <option {{$field->field_type === "date_input"? "selected" : "" }} value="date_input">date_input</option>
                        </select>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control js-example-basic-single2" id="isRequired" name="isRequired">
                            ...
                            <option {{ $field->isRequired === 1 ? "selected" : "" }} value="1">Yes</option>
                            <option {{ $field->isRequired === 0 ? "selected" : "" }} value="0">No</option> 
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control js-example-basic-single3" id="active_status" name="active_status">
                            <option selected value="">Choose One Option</option>
                            <option {{ $field->active_status === 0 ? "selected" : "" }} value="0">Inactive</option>
                            <option {{ $field->active_status === 1 ? "selected" : "" }} value="1" selected>Active</option>
                        </select>
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            document.getElementById('merchandiser_report_type_id').disabled = true;
        });
    </script>
@endsection
