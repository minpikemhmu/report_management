        ...
        <div class="card mx-auto mb-5 mt-3">
            <div class="row m-3">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <span class="">Add a new Product Key Category</span>
                    <form method="POST" action="{{ route('product_key_cateogories.store') }}">
                        @csrf

                        <div class="form-group">
                            <label for="name">Product Key Category Name</label>
                            <input name="name" type="text" class="form-control" id="name"
                                placeholder="Product Key Category Name" value="{{ old('name') }}">
